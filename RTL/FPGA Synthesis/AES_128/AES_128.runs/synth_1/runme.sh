...
HD_PWD='F:/Aloshka/Collage/post collage material/AES/RTL/FPGA Synthesis/AES_128/AES_128.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_128.tcl
