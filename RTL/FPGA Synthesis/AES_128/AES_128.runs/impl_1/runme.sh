...
HD_PWD='F:/Aloshka/Collage/post collage material/AES/RTL/FPGA Synthesis/AES_128/AES_128.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_128.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_128.tcl -notrace
